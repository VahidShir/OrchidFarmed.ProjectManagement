...
using ProjectManagement.Application.Contracts.Settings;
...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            options.IncludeXmlComments(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ProjectManagement.WebApi.xml"));
        });
    ...
    {
        var applicationProjectAssemblyPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ProjectManagement.Application.dll");
